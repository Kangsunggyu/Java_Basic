...
class Calculator {
    ...
    public double DoOperation(double a, double b, Operator operator) {
        double result = 0;
        try {
...
enum Operator {
    ...
    private final BinaryOperator<Double> operation; // 연산 로직 (Double 타입을 가정)
    ...
    // 실제 연산
    public double applyEnum(Double a, Double b) {
