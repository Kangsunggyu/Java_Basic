...
class Buyer2{
    ...
    int i=0;
    void buy(Product2 p){ // _07_객체지향언어.Product 타입을 매개변수로 받기에, Product의 모든 자손 객체를 받을 수 있다.
        // 조상 타입으로 매개변수를 선언하면, 자손 타입의 객체도 모두 전달할 수 있다!
        // 실제로는 Tv나 _07_객체지향언어.Computer 객체가 올 수 있음 → 업캐스팅 자동 적용!
        if(money < p.price){
